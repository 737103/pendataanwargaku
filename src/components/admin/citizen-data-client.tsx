...
import { getCitizens, deleteCitizen, type Citizen } from '@/lib/firestore';
...
import { EditCitizenForm } from '@/components/dashboard/edit-citizen-form';
import { CitizenDetailView } from './citizen-detail-view';
import { Input } from '../ui/input';


const ITEMS_PER_PAGE = 5;

export function CitizenDataClient() {
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={8} className="h-24 text-center">
                 {searchTerm ? `Tidak ada data yang cocok dengan "${searchTerm}".` : 'Tidak ada data warga yang dientri.'}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
       ...
       <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[650px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Lakukan perubahan pada data. Klik simpan jika sudah selesai.
            </DialogDescription>
          </DialogHeader>
        ...
        <DialogContent className="sm:max-w-[650px]">
          <DialogHeader>
            <DialogTitle>Detail Data Warga</DialogTitle>
             <DialogDescription>
              Informasi lengkap mengenai warga yang dipilih.
            </DialogDescription>
          </DialogHeader>
