...
function AuthForm() {
    ...
    async function onSubmit(values) {
        setLoading(true);
        try {
            const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyUserCredentials"])(values.username, values.password);
            if (user) {
                localStorage.setItem('userRole', user.role);
                localStorage.setItem('username', values.username);
                toast({
                    title: 'Login Berhasil!',
                    description: `Anda masuk sebagai ${user.role === 'admin' ? 'Admin' : 'Pengguna'}.`
                });
                if (user.role === 'admin') {
                    router.push('/admin');
                } else {
...
_s(AuthForm, "hIxZ8T4aPV2EJHg5kjAHkfxa1Qs=", false, function() {
    return [
...
//# sourceMappingURL=src_27717da8._.js.map